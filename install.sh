...
if [ "$n" != "" ]; then
if [ "$n" == "1" ]; then
linkd=https://api.github.com/repos/sisu-sisu/X-Panel-SSH-User-Management/releases/tags/xpanelv37
fi
else
linkd=https://api.github.com/repos/sisu-sisu/X-Panel-SSH-User-Management/releases/tags/xpanelv37
fi
...
bash <(curl -Ls https://raw.githubusercontent.com/sisu-sisu/Nethogs-Json-main/master/install.sh --ipv4)
...
wait
curl -o /root/xpanel.sh https://raw.githubusercontent.com/sisu-sisu/X-Panel-SSH-User-Management/main/cli.sh
